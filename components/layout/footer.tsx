  ...
  return (
      <div className="absolute w-full py-5 text-center">
          ...
          <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mx-auto mb-5 flex max-w-fit animate-fade-up items-center justify-center space-x-2 overflow-hidden rounded-full px-7 py-2 transition-colors hover:opacity-70"
