...
const features = [
  {
    ...
    demo: (
      <a
        href={"https://blackjack.mini-games.sui.io/"}
        target={"_blank"}
        rel="noreferrer"
      >
        <Image
          ...
          className={"animate-fade-down rounded-lg hover:opacity-70"}
          unoptimized
        />
      </a>
    ),
  ...
  },
  {
    ...
    demo: (
      <a
        href={"https://satoshi-flip.mystenlabs.com/"}
        target={"_blank"}
        rel="noreferrer"
      >
        <Image
  ...
  },
  {
    ...
    demo: (
      <a
        href={"https://plinko.mini-games.sui.io/"}
        target={"_blank"}
        rel="noreferrer"
      >
        <Image
  ...
  },
  {
    ...
    demo: (
      <a
        href={"https://solitaire.mini-games.sui.io/"}
        target={"_blank"}
        rel="noreferrer"
      >
        <Image
